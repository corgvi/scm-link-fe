            ...
            <div>
              ...
              <form @submit.prevent="handleSubmit">
                <div class="space-y-5">
                  ...
                  <div>
                    <label for="dob" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                  ...
                  <div v-if="errorMsg" class="text-error-500 text-sm">{{ errorMsg }}</div>
                  <!-- Checkbox -->
                  <div>
                    <div>
                      <label
