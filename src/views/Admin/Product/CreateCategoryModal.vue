<template>
  <div class="no-scrollbar relative w-full max-w-[720px] overflow-y-auto rounded-3xl bg-white p-6 dark:bg-gray-900">
    ...
    <p class="mb-6 text-sm text-gray-500 dark:text-gray-400">Fill in the details below to create a new category.</p>
...
async function submit() {
  ...
  try {
    ...
    if (res.ok && data.code === 1000) {
      ...
      errorMessage.value = data.message || 'Failed to create category'
    }
  } catch (e) {
